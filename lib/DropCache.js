...
const allDataCache = new FetchCache('https://drops.warframestat.us/data/all.slim.json', 86400000);
...
function formatData(data) {
  return data.map(reward => ({
    place: reward.place.replace('Derelict/', '') // eslint-disable-line no-param-reassign
